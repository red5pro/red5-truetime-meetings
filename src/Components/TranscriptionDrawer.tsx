...
const TranscriptionDrawer = React.memo<TranscriptionDrawerProps>((props) => {
    ...
    const handleCopyForLLM = useCallback(() => {
        if (props.data?.transcriptionsByUser) {
            ...
            Object.entries(props.data.transcriptionsByUser).forEach(([user, userCaptions]: [string, any]) => {
        ...
        >
            ...
            >
                <Grid container justifyContent="space-between" alignItems="center" sx={{ mb: 2 }}>
                    ...
                    <CloseDrawerButton
                        handleInfoDrawerOpen={() => props?.onClose?.(false)}
                    />
                </Grid>
                ...
                {props.data && (
                    <>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 2 }}>
                            ...
                            <Box>
                                <IconButton onClick={handleCopyForLLM} size="small" title={t('Copy for LLM')} sx={{ mr: 1 }}>
