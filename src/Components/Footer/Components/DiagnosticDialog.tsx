...
const ConnectionStats: React.FC<ConnectionStatsProps> = ({ connectionId, stats, connectionType }) => {
                    ...
                    {(stats.outboundVideo || stats.inboundVideo) && (
                        <Grid item xs={6}>
                            ...
                            {stats.outboundVideo && (
                                <Box>
                                    <Typography variant="body2" fontSize="0.75rem">
                                        📤 {formatBitrate(stats.quality?.bitrate)} • {stats.outboundVideo.framesPerSecond || 0} fps
                                    </Typography>
                                    <Typography variant="body2" fontSize="0.75rem">
                                        📦 {stats.outboundVideo.packetsSent || 0} sent • {stats.outboundVideo.packetsLost || 0} lost
                                    </Typography>
                                    <Typography variant="body2" fontSize="0.75rem">
                            ...
                            {stats.inboundVideo && (
                                <Box>
                                    <Typography variant="body2" fontSize="0.75rem">
                                        📥 {formatBitrate(stats.quality?.bitrate)} • {stats.inboundVideo.framesPerSecond || 0} fps
                                    </Typography>
                                    <Typography variant="body2" fontSize="0.75rem">
                                        📦 {stats.inboundVideo.packetsReceived || 0} recv • {stats.inboundVideo.packetsLost || 0} lost
                                    </Typography>
                                    <Typography variant="body2" fontSize="0.75rem">
...
export function DiagnosticDialog({
    ...
    return (
        ...
        >
            <Red5DialogTitle onClose={handleClose}>
                {t('Network Diagnostic')} 📊
            </Red5DialogTitle>
                    ...
                    <Grid container spacing={2} sx={{ mb: 3 }}>
                        <Grid item xs={6}>
                            <QualityIndicator
                                ...
                                score={scores.inbound}
                                icon="📥"
                            />
                        </Grid>
                        <Grid item xs={6}>
                            <QualityIndicator
                                label="Outbound Quality"
                                score={scores.outbound}
                                icon="📤"
                            />
                        </Grid>
                    </Grid>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={4}>
                                    ...
                                    <Typography variant="h6">
                                        {Object.keys(scores.statsSamples).length}
                                    </Typography>
                                </Grid>
                                <Grid item xs={4}>
                                    <Typography variant="caption" color="textSecondary">
