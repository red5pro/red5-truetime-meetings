        ...
        <>
            ...
            >
                ...
                <MenuItem disabled={!props?.captionsVisible} onClick={handleCaptionsClick}>
                    <ListItemIcon>
                        {props?.captionsVisible ? <ClosedCaption sx={{ color: "#fff" }} /> : <ClosedCaptionDisabled sx={{ color: "#fff" }} />}
                    </ListItemIcon>
                    <ListItemText id="more-options-captions-button"
                        sx={{
                            '& .MuiListItemText-primary': {
                                color: !props?.captionsVisible ? 'text.disabled' : 'text.primary'
                            }
                        }}>
                        {!isCaptionEnabled ? t("Upgrade your plan to support closed captioning") : (props?.captionsVisible ? t("Hide Captions") : t("Show Captions"))}
                    </ListItemText>
                </MenuItem>
                ...
                <MenuItem onClick={handleReactionsClick}>
                    ...
                    <ListItemText id="more-options-reactions-button">
                        {t("Reactions")}
                    </ListItemText>
                </MenuItem>
                ...
                <MenuItem onClick={handleRaiseHandClick}>
                    ...
                    <ListItemText id="more-options-raise-hand-button">
                        {t("Raise hand")}
                    </ListItemText>
                </MenuItem>
                ...
                <MenuItem onClick={handleMeetingDetailsClick}>
                    ...
                    <ListItemText id={"more-options-meeting-details-button"}>{t("Meeting details")}</ListItemText>
                </MenuItem>
