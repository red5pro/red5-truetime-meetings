                    ...
                    >
                        <Grid size="auto">
                            <OptionButton
                                ...
                                setSelectedBackgroundMode={(mode: string) => props?.setSelectedBackgroundMode?.(mode)}
                                layout={props?.layout}
                                ...
                                startRecord={(recordSeparately?: boolean, serverRecording?: boolean, localRecording?: boolean) => props?.startRecord?.(recordSeparately, serverRecording, localRecording)}
                                stopRecord={(serverRecording?: boolean, localRecording?: boolean) => props?.stopRecord?.(serverRecording, localRecording)}
                                //@ts-ignore
                                ...
                                setPrintStatLogs={(printStatLogs: boolean) => props?.setPrintStatLogs?.(printStatLogs)}
                        ...
                        {(props?.isPlayOnly === false) && (!isMobile) && (!isTablet) && (windowWidth > mobileBreakpoint) ? (
                            <Grid size="auto">
                                <ShareScreenButton
                                    footer={true}
                                    glass={props?.glass}
                        ...
                        {windowWidth <= mobileBreakpoint ? (
                            <Grid size="auto">
                                <MoreOptionsButton
                                    ...
                                    toggleSetNumberOfUnreadMessages={(numberOfUnreadMessages?: number) => props?.toggleSetNumberOfUnreadMessages?.(numberOfUnreadMessages)}
