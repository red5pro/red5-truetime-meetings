...
export const useConferenceActions = (
    ...
    const joinRoomCallback = useCallback(
        ...
        [client, setIsJoining, setIsWaitingApproval, publishStreamIdRef, role, streamName, isPlayOnly, isMyCamTurnedOff, isMyMicMuted, preJoinChecks, googleToken],
    );
    ...
    }, [client, setParticipants, setSubscribedParticipants, talkerAudioLevelsRef, setIsJoining, setIsWaitingApproval]);
