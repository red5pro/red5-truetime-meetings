...
export const useCustomNotification = (): CustomNotificationHook => {
    ...
    const showSuccess = useCallback((message: string, options?: NotificationOptions): void =>
    displayMessage(message, 'success', options), [displayMessage]);

    const showError = useCallback((message: string, options?: NotificationOptions): void =>
    displayMessage(message, 'error', { duration: 8000, ...options }), [displayMessage]);

    const showWarning = useCallback((message: string, options?: NotificationOptions): void =>
    displayMessage(message, 'warning', options), [displayMessage]);

    const showInfo = useCallback((message: string, options?: NotificationOptions): void =>
    displayMessage(message, 'info', options), [displayMessage]);
