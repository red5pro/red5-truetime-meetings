...
const LayoutPinned = React.memo<LayoutPinnedProps>((props) => {
    ...
    const participantGroups = useMemo<ParticipantGroups>(() => {
        ...
        const audioOnlyParticipants = unpinnedParticipants.slice(participantCounts.maxPlayingParticipants)
    ...
    const renderVisibleVideoCards = useCallback((isMobileView: boolean = false) => {
    ...
    const renderUnpinnedGallery = useCallback((isMobileView: boolean = false) => {
        return (
