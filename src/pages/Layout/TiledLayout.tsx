...
const LayoutTiled = React.memo<LayoutTiledProps>((props) => {
    ...
    const layoutConfig = useMemo<LayoutConfig>(() => {
        ...
        const showOthers = allParticipants.length > (globals?.desiredTileCount || allParticipants.length)
    ...
    const renderVideoCard = useCallback((participantObject: ParticipantObject, _index: number) => {
    ...
    const renderOthersCard = useCallback(() => {
        ...
        const othersCount = allParticipants.length - (globals?.desiredTileCount || allParticipants.length)
        ...
        layoutConfig.showOthers,
        cardDimensions,
        allParticipants.length,
        globals?.desiredTileCount
    ])
