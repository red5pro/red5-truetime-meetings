...
i18n.changeLanguage(preferredLanguage).then(r => log.log("Language is set to", preferredLanguage, r));
...
function App(): JSX.Element {
    ...
    const [currentTheme, setCurrentTheme] = useState<string>(getRuntimeConfig().VITE_DEFAULT_THEME || ThemeList.Black);
    ...
    useEffect(() => {
        ...
        if (getRuntimeConfig().VITE_ENABLE_CLOSED_CAPTION !== 'true') {
            log.warn('Closed captions feature is disabled. Set VITE_ENABLE_CLOSED_CAPTION=true to enable.');
        } else {
